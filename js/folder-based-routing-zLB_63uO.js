...
│   └── page.tsx      → /blog
└── contact/
    └── page.tsx      → /contact`}),(0,u.jsxs)(`p`,{className:`text-slate-300 mt-4`,children:[`This creates four routes: `,(0,u.jsx)(`code`,{className:`text-cyan-400`,children:`/`}),`, `,(0,u.jsx)(`code`,{className:`text-cyan-400`,children:`/about`}),`, `,(0,u.jsx)(`code`,{className:`text-cyan-400`,children:`/blog`}),`, and `,(0,u.jsx)(`code`,{className:`text-cyan-400`,children:`/contact`}),`.`]})]}),(0,u.jsxs)(a.section,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.2},children:[(0,u.jsx)(`h2`,{className:`text-2xl font-bold text-white mb-4 border-b border-slate-800 pb-2`,children:`Nested Routes`}),(0,u.jsx)(`p`,{className:`text-slate-300 mb-4`,children:`Nest folders inside each other to create nested URL segments. Each level adds another segment to the URL path.`}),(0,u.jsx)(d,{code:`src/app/
├── blog/
│   ├── page.tsx           → /blog
│   ├── authors/
...
└── not-found.tsx              ← Custom 404 page`})]}),(0,u.jsxs)(a.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.6},className:`flex items-center justify-between pt-8 mt-8 border-t border-slate-800`,children:[(0,u.jsxs)(n,{to:`/docs/linking-and-navigating`,className:`group flex items-center gap-2 text-slate-400 hover:text-white transition-colors`,children:[(0,u.jsx)(o,{className:`w-4 h-4 group-hover:-translate-x-1 transition-transform`}),(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`div`,{className:`text-xs text-slate-500`,children:`Previous`}),(0,u.jsx)(`div`,{className:`text-sm font-medium`,children:`Linking and Navigating`})]})]}),(0,u.jsxs)(n,{to:`/docs/file-based-routing`,className:`group flex items-center gap-2 text-right text-slate-400 hover:text-white transition-colors`,children:[(0,u.jsxs)(`div`,{children:[(0,u.jsx)(`div`,{className:`text-xs text-slate-500`,children:`Next`}),(0,u.jsx)(`div`,{className:`text-sm font-medium`,children:`File-Based Routing`})]}),(0,u.jsx)(s,{className:`w-4 h-4 group-hover:translate-x-1 transition-transform`})]})]})]})})})})]})}export{p as default};