...
}`,filename:`src/app/api/safe.ts`})]}),(0,m.jsxs)(a.section,{id:`when-to-use`,initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.55},className:`scroll-mt-24`,children:[(0,m.jsx)(`h2`,{className:`text-2xl font-bold text-white mb-4 border-b border-slate-800 pb-2`,children:`When to Use Plain Handlers`}),(0,m.jsx)(b,{headers:[`Scenario`,`Recommendation`],rows:[[`Single endpoint with simple logic`,(0,m.jsxs)(`span`,{className:`flex items-center gap-1`,children:[(0,m.jsx)(l,{className:`w-3.5 h-3.5 text-emerald-400`}),` Plain handler`]})],[`Quick prototypes`,(0,m.jsxs)(`span`,{className:`flex items-center gap-1`,children:[(0,m.jsx)(l,{className:`w-3.5 h-3.5 text-emerald-400`}),` Plain handler`]})],[`Simple CRUD operations`,(0,m.jsxs)(`span`,{className:`flex items-center gap-1`,children:[(0,m.jsx)(l,{className:`w-3.5 h-3.5 text-emerald-400`}),` Plain handler`]})],[`Multiple endpoints in one file`,(0,m.jsxs)(`span`,{className:`flex items-center gap-1`,children:[(0,m.jsx)(u,{className:`w-3.5 h-3.5 text-rose-400`}),` Use Hono`]})],[`Need middleware`,(0,m.jsxs)(`span`,{className:`flex items-center gap-1`,children:[(0,m.jsx)(u,{className:`w-3.5 h-3.5 text-rose-400`}),` Use Hono`]})],[`Complex routing patterns`,(0,m.jsxs)(`span`,{className:`flex items-center gap-1`,children:[(0,m.jsx)(u,{className:`w-3.5 h-3.5 text-rose-400`}),` Use Hono`]})],[`Production APIs with many routes`,(0,m.jsxs)(`span`,{className:`flex items-center gap-1`,children:[(0,m.jsx)(u,{className:`w-3.5 h-3.5 text-rose-400`}),` Use Hono`]})]]}),(0,m.jsx)(x,{children:`Start with plain handlers for simple endpoints. Switch to Hono when you need middleware, complex routing, or better organization.`})]}),(0,m.jsxs)(a.section,{id:`complete-example`,initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.6},className:`scroll-mt-24`,children:[(0,m.jsx)(`h2`,{className:`text-2xl font-bold text-white mb-4 border-b border-slate-800 pb-2`,children:`Complete Example`}),(0,m.jsx)(`p`,{className:`text-slate-300 mb-4`,children:`A full-featured plain function handler with validation, error handling, and multiple methods:`}),(0,m.jsx)(y,{code:`// src/app/api/todos.ts → /api/todos
import { getEnv } from 'bini-env'
