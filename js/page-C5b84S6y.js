import{i as e,n as t,t as n}from"./jsx-runtime-8V1sTRGR.js";import{t as r}from"./Header-ZPFKDZno.js";var i=n(),a=e(t(),1),o=[{id:`quick-start`,label:`Quick Start`,group:`Introduction`},{id:`file-routing`,label:`File-based Routing`,group:`Core Concepts`},{id:`api-routes`,label:`API Routes`,group:`Core Concepts`},{id:`layouts-metadata`,label:`Layouts & Metadata`,group:`Core Concepts`},{id:`deploy-platforms`,label:`Deploy Platforms`,group:`Deployment`}],s=[`Introduction`,`Core Concepts`,`Deployment`],c=[`netlify`,`cloudflare`,`node`,`deno`,`bun`,`aws`],l={netlify:{config:`// vite.config.ts
