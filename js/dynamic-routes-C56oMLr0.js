...
└── users/
    └── [userId]/
        └── page.tsx       → /users/john
                            → /users/mary`}),(0,f.jsxs)(`p`,{className:`text-slate-300 mt-4`,children:[`Access the parameter value using `,(0,f.jsx)(`code`,{className:`text-cyan-400`,children:`useParams()`}),`:`]}),(0,f.jsx)(_,{code:`// src/app/blog/[slug]/page.tsx
export default function BlogPost() {
  const { slug } = useParams()
  
  return <h1>Post: {slug}</h1>
}`,filename:`app/blog/[slug]/page.tsx`})]}),(0,f.jsxs)(a.section,{id:`multiple-parameters`,initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.2},className:`scroll-mt-24`,children:[(0,f.jsx)(`h2`,{className:`text-2xl font-bold text-white mb-4 border-b border-slate-800 pb-2`,children:`Multiple Parameters`}),(0,f.jsx)(`p`,{className:`text-slate-300 mb-4`,children:`You can have multiple dynamic segments in a single route:`}),(0,f.jsx)(_,{code:`src/app/
└── blog/
    └── [category]/
        └── [slug]/
            └── page.tsx   → /blog/tech/hello-world
                            → /blog/lifestyle/travel-tips`}),(0,f.jsx)(_,{code:`// src/app/blog/[category]/[slug]/page.tsx
export default function BlogPost() {
...
}`,filename:`app/blog/[category]/[slug]/page.tsx`}),(0,f.jsx)(v,{headers:[`URL`,`params`],rows:[[`/blog/tech/hello-world`,`{ category: "tech", slug: "hello-world" }`],[`/blog/lifestyle/travel`,`{ category: "lifestyle", slug: "travel" }`]]})]}),(0,f.jsxs)(a.section,{id:`catch-all-segments`,initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.25},className:`scroll-mt-24`,children:[(0,f.jsx)(`h2`,{className:`text-2xl font-bold text-white mb-4 border-b border-slate-800 pb-2`,children:`Catch-all Segments`}),(0,f.jsxs)(`p`,{className:`text-slate-300 mb-4`,children:[`Use `,(0,f.jsx)(`code`,{className:`text-cyan-400`,children:`[...name]`}),` to match any number of segments. The parameter becomes an array of the matched segments.`]}),(0,f.jsx)(_,{code:`src/app/
└── docs/
    └── [...slug]/
...
}`,filename:`app/docs/[...slug]/page.tsx`}),(0,f.jsx)(v,{headers:[`URL`,`slug value`],rows:[[`/docs/getting-started`,`['getting-started']`],[`/docs/api/reference`,`['api', 'reference']`],[`/docs/guides/routing/basics`,`['guides', 'routing', 'basics']`]]}),(0,f.jsxs)(`p`,{className:`text-slate-300 mt-4`,children:[(0,f.jsx)(`strong`,{className:`text-white`,children:`Note:`}),` Catch-all segments have lower priority than static routes and dynamic single segments. For example, `,(0,f.jsx)(`code`,{className:`text-cyan-400`,children:`/blog/featured`}),` will match a static route if it exists, falling back to the catch-all only if no more specific route matches.`]})]}),(0,f.jsxs)(a.section,{id:`optional-catch-all`,initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.3},className:`scroll-mt-24`,children:[(0,f.jsx)(`h2`,{className:`text-2xl font-bold text-white mb-4 border-b border-slate-800 pb-2`,children:`Optional Catch-all Segments`}),(0,f.jsxs)(`p`,{className:`text-slate-300 mb-4`,children:[`Use `,(0,f.jsx)(`code`,{className:`text-cyan-400`,children:`[[...name]]`}),` to make the catch-all optional. The route matches even without any segments, making it perfect for multi-level navigation like documentation or shop categories.`]}),(0,f.jsx)(_,{code:`src/app/
└── shop/
    └── [[...slug]]/
        └── page.tsx       → /shop
                            → /shop/clothing
...
}`,filename:`app/shop/[[...slug]]/page.tsx`}),(0,f.jsx)(v,{headers:[`URL`,`slug value`],rows:[[`/shop`,`undefined`],[`/shop/clothing`,`['clothing']`],[`/shop/clothing/shirts`,`['clothing', 'shirts']`]]})]}),(0,f.jsxs)(a.section,{id:`dynamic-layouts`,initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.35},className:`scroll-mt-24`,children:[(0,f.jsx)(`h2`,{className:`text-2xl font-bold text-white mb-4 border-b border-slate-800 pb-2`,children:`Dynamic Segments in Layouts`}),(0,f.jsxs)(`p`,{className:`text-slate-300 mb-4`,children:[`Layouts can also access dynamic parameters using `,(0,f.jsx)(`code`,{className:`text-cyan-400`,children:`useParams()`}),`, which is auto-imported:`]}),(0,f.jsx)(_,{code:`// src/app/blog/[slug]/layout.tsx
...
└── products/
    ...
    └── categories/
        └── [name]/
            └── page.tsx       → /products/categories/:name`})]}),(0,f.jsxs)(a.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.55},className:`flex items-center justify-between pt-8 mt-8 border-t border-slate-800`,children:[(0,f.jsxs)(n,{to:`/docs/file-based-routing`,className:`group flex items-center gap-2 text-slate-400 hover:text-white transition-colors`,children:[(0,f.jsx)(o,{className:`w-4 h-4 group-hover:-translate-x-1 transition-transform`}),(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`div`,{className:`text-xs text-slate-500`,children:`Previous`}),(0,f.jsx)(`div`,{className:`text-sm font-medium`,children:`File-Based Routing`})]})]}),(0,f.jsxs)(n,{to:`/docs/catch-all-routes`,className:`group flex items-center gap-2 text-right text-slate-400 hover:text-white transition-colors`,children:[(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`div`,{className:`text-xs text-slate-500`,children:`Next`}),(0,f.jsx)(`div`,{className:`text-sm font-medium`,children:`Catch-All Routes`})]}),(0,f.jsx)(s,{className:`w-4 h-4 group-hover:translate-x-1 transition-transform`})]})]})]}),(0,f.jsx)(`aside`,{className:`hidden xl:block w-56 shrink-0`,children:(0,f.jsx)(u,{items:p,editUrl:g})})]})})})})]})}export{y as default};